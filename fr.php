...
<head>
    ...
    <meta name="description" content="Libérez tout le potentiel de vos vidéos avec mes services de montage vidéo et faites-les résplendir.">
    ...
    <meta property="og:description" content="Libérez tout le potentiel de vos vidéos avec mes services de montage vidéo et faites-les résplendir." />
    ...
    <meta property="twitter:description" content="Libérez tout le potentiel de vos vidéos avec mes services de montage vidéo et faites-les résplendir." />
    ...
    <title>Lilian Bischung - Monteur Video</title>
</head>
<body>
    ...
    <header class="header-section">
        <div class="container">
            <div class="intro">
                    ...
                    <h2 class="effect-shine">Dévoilez le plein potentiel de vos vidéos</h2>
            </div>
        </div>
    </header>
    ...
    <img style="" src="../assets/logo-big.png" class="logo" alt="Lilian Bischung Logo">   
        ...
        <div class="container reveal">
            ...
            <div class="toggle-container reveal">
                ...
                <h3 onclick="togglePage('.shorts-container')">Format tiktok</h3>
            </div> 
    ...
    <section id="contact" class="contact-section reveal">
        <div class="container">
            <h2>Me contacter</h2>
            <h3>Interessé par mes services ? Contactez moi !</h3>
